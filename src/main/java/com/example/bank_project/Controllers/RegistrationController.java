...
public class RegistrationController {
    ...
    public String registerUser(@ModelAttribute RegistrationForm form) {
        ...
        return "redirect:/register/document"; // После регистрации перенаправить на страницу входа
    }

//    @PostMapping("/saveDocument")
//    public String registerDocument(@ModelAttribute DocumentForm form, Principal principal) {
//        if (principal == null) {
